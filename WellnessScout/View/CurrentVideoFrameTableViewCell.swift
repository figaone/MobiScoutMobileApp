//
//  CurrentVideoFrameTableViewCell.swift
//  WellnessScout
//
...
class CurrentVideoFrameTableViewCell: UITableViewCell {

    static let identifier = "CurrentVideoFrameTableViewCell"
    //MARK:Helper classes
...
//        accessoryType = .none
    ...
    public func configure(with model: CurrentVidFrameSettingsOption){
        userData = defaultManager.getUserDefaults()
        print(userData.frequency as Any)
        label.text = model.title
        valuelabel.text = "\(Int(userData.frameRate ?? vidManager.getMaxFrameRateValue()))fps"
