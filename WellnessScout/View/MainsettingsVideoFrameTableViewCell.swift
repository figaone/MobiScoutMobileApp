//
//  MainsettingsVideoFrameTableViewCell.swift
//  WellnessScout
//
...
class MainsettingsVideoFrameTableViewCell: UITableViewCell {

    static let identifier = "MainsettingsVideoFrameTableViewCell"
...
//                             , height: contentView.frame.size.height)
    ...
    public func configure(with model: VideoFrameSettingsSliderOption){
        userData = defaultManager.getUserDefaults()
        label.text = model.title
        iconImageView.image = model.icon
        iconContainer.backgroundColor = model.iconBackgroundColor
//        mySwitch.isOn = model.isOn
        mySlider.value = Float(userData.frameRate ??  vidManager.getMaxFrameRateValue())
        valuelabel.text = String(Int(userData.frameRate ??  vidManager.getMaxFrameRateValue())) + "fps"
    }
